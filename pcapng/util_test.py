...
def test_pad_to_block32():
    ...
    assert to_bytes( [1, 0, 0, 0            ] ) == pcapng.util.pad_to_block32( [1                     ] )
    assert to_bytes( [1, 2, 0, 0            ] ) == pcapng.util.pad_to_block32( [1, 2                  ] )
    assert to_bytes( [1, 2, 3, 0            ] ) == pcapng.util.pad_to_block32( [1, 2, 3               ] )
    assert to_bytes( [1, 2, 3, 4            ] ) == pcapng.util.pad_to_block32( [1, 2, 3, 4            ] )
    assert to_bytes( [1, 2, 3, 4, 5, 0, 0, 0] ) == pcapng.util.pad_to_block32( [1, 2, 3, 4, 5         ] )
    assert to_bytes( [1, 2, 3, 4, 5, 6, 0, 0] ) == pcapng.util.pad_to_block32( [1, 2, 3, 4, 5, 6      ] )
    assert to_bytes( [1, 2, 3, 4, 5, 6, 7, 0] ) == pcapng.util.pad_to_block32( [1, 2, 3, 4, 5, 6, 7   ] )
    assert to_bytes( [1, 2, 3, 4, 5, 6, 7, 8] ) == pcapng.util.pad_to_block32( [1, 2, 3, 4, 5, 6, 7, 8] )
